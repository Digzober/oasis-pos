...
const ROUTES = [
  ...
  'customers/configure/doctors/[id]',
  'customers/configure/qualifying-conditions/[id]',
  'delivery/zones/[id]',
  'discounts/[id]',
  ...
  'registers/configure/order-sources/[id]',
  'registers/configure/transaction-reasons/[id]',
