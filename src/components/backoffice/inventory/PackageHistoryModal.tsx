      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-edge shrink-0">
            <h2 className="text-lg font-semibold text-primary">Package History</h2>
            <button
              onClick={onClose}
          ...
          <div className="flex-1 overflow-y-auto p-6">
            {loading ? (
              ...
              <div className="text-center py-12">
                <p className="text-muted text-sm">No history entries found.</p>
              </div>
            ) : (
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {entries.map(entry => (
                      <tr key={entry.id} className="border-b border-edge/50 hover:bg-raised/20">
                        ...
                        <td className="px-3 py-2 whitespace-nowrap">
                          <span className="inline-block text-xs font-medium px-2 py-0.5 rounded bg-raised text-secondary">
                            {entry.event_type}
                          </span>
                        </td>
                        <td className="px-3 py-2 text-secondary whitespace-nowrap">
                        ...
                        <td className="px-3 py-2 text-danger whitespace-nowrap max-w-[150px] truncate">
                          {entry.old_value ?? '\u2014'}
                        </td>
                        <td className="px-3 py-2 text-accent whitespace-nowrap max-w-[150px] truncate">
                          {entry.new_value ?? '\u2014'}
                        </td>
                      </tr>
                    ))}
