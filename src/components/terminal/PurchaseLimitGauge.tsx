  ...
  return (
    <div className="px-4 py-2 border-b border-edge">
      <div className="flex items-center justify-between text-xs mb-1">
        <span className="text-secondary">Purchase Limit</span>
        <span className={`font-medium ${pct > 95 ? 'text-danger' : 'text-secondary'}`}>
      ...
      {!limit.allowed && (
        <p className="text-danger text-[10px] mt-1 font-medium">Exceeds limit — cannot complete sale</p>
      )}
    </div>
  )
}
